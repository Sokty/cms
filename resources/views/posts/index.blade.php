          ...
          <tbody>
                @foreach($posts as $post)
                    <tr>
                      ...
                      <td><a href="{{route('posts.show',$post->id)}}" class="btn btn-outline-warning btn-sm">View</a> <a href="{{route('posts.edit',$post->id)}}" class="btn btn-outline-danger btn-sm">Edit</a></td>
                    </tr>
                @endforeach 
          </tbody>
      </table>
